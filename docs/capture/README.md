...
6. Save any additional named screenshots in `docs/assets/screenshots/` and reference them from the relevant guide.
7. Review every image for sensitive data before committing it.
