...
- `docs/architecture/decisions.md`: update if scaffold implementation changes an existing decision.

## Task 1: Scaffold Laravel In Repo Root

**Files:**
- Create: Laravel application files in repository root.
- Preserve: `docs/architecture/decisions.md`
- Preserve: `docs/archive/specifications/2026-07-31-initial-scaffold-design.md`
- Preserve: `docs/archive/plans/2026-07-31-initial-scaffold.md`
