...
- `docs/product/overview.md`: product purpose, users, tone, anti-references, and strategic principles.
- `docs/product/design.md`: colors, typography, layout rules, component decisions, and interaction principles.
