...
class UpdateConnectionGroupRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        $connectionGroup = $this->route('connection_group');
        ...
        return [
            'name' => [
                ...
                'string',
                'max:255',
                Rule::unique(ConnectionGroup::class, 'name')->ignore($connectionGroup),
            ],
