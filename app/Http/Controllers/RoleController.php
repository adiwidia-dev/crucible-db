...
class RoleController extends Controller
{
            ...
            'role' => [
                ...
                'policies' => $role->databasePermissions->mapWithKeys(fn (RoleDatabasePermission $permission): array => [
                    (string) $permission->database_connection_id => [
                        ...
                        'native_proxy_access_mode' => $permission->native_proxy_access_mode->value,
    ...
    /**
     * @param  array<int, array{database_connection_id: int, access_mode: string, query_access_mode: string, native_proxy_access_mode: string, can_review: bool, read_requires_approval: bool, write_requires_approval: bool, max_write_session_minutes: int|null}>  $policies
     */
    ...
    /**
     * @param  array<int, array{connection_group_id: int, access_mode: string, query_access_mode: string, native_proxy_access_mode: string, can_review: bool, read_requires_approval: bool, write_requires_approval: bool, max_write_session_minutes: int|null}>  $policies
     */
