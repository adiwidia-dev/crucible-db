...
<p align="center">
  ...
  <a href="https://github.com/adiwidia-dev/crucible-db/releases/tag/v0.2.10"><img src="https://img.shields.io/badge/release-v0.2.10-2563EB" alt="Crucible DB v0.2.10"></a>
...
For the Docker development stack, run `docker compose exec -T app composer ci:check`. PHPUnit explicitly overrides the initial-setup token in both the environment and `$_SERVER`, so the development container's deployment token cannot leak into setup tests.
